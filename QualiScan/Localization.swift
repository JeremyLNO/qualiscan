...
enum L {
    ...
    static let table: [String: [AppLanguage: String]] = [
        ...
        "pay_subscribe": [.en: "Subscribe", .fr: "S'abonner", .de: "Abonnieren", .es: "Suscribirse", .pt: "Subscrever"],
        ...
        "pay_terms": [.en: "Payment is charged to your Apple Account. Subscriptions renew automatically unless cancelled at least 24 h before the end of the period — manage or cancel anytime in the App Store.", .fr: "Le paiement est débité de votre compte Apple. L'abonnement se renouvelle automatiquement sauf annulation au moins 24 h avant la fin de la période — gérable ou annulable à tout moment dans l'App Store.", .de: "Die Zahlung erfolgt über Ihr Apple-Konto. Abos verlängern sich automatisch, sofern nicht mindestens 24 Std. vor Periodenende gekündigt — jederzeit im App Store verwaltbar.", .es: "El pago se carga a tu cuenta de Apple. La suscripción se renueva automáticamente salvo cancelación al menos 24 h antes del fin del periodo — gestiónala cuando quieras en la App Store.", .pt: "O pagamento é cobrado na sua conta Apple. A subscrição renova-se automaticamente salvo cancelamento até 24 h antes do fim do período — faça a gestão na App Store."],
        ...
        "pay_trial_ended": [.en: "Your free trial has ended", .fr: "Votre essai gratuit est terminé", .de: "Ihre kostenlose Testphase ist beendet", .es: "Tu prueba gratuita ha terminado", .pt: "O seu teste gratuito terminou"],
        "pay_feat_unlimited_detail": [.en: "Scan and keep as many documents as you need.", .fr: "Scannez et conservez autant de documents que vous voulez.", .de: "Scanne und behalte so viele Dokumente, wie du brauchst.", .es: "Escanea y guarda todos los documentos que quieras.", .pt: "Digitalize e guarde tantos documentos quantos precisar."],
        "pay_feat_ocr_detail": [.en: "On-device text recognition in every scan.", .fr: "Reconnaissance de texte sur l'appareil dans chaque scan.", .de: "Texterkennung direkt auf dem Gerät in jedem Scan.", .es: "Reconocimiento de texto en el dispositivo en cada escaneo.", .pt: "Reconhecimento de texto no dispositivo em cada digitalização."],
        "pay_feat_export_detail": [.en: "Multi-page searchable PDFs, with an optional watermark.", .fr: "PDF multi-pages recherchables, avec filigrane en option.", .de: "Mehrseitige durchsuchbare PDFs, optional mit Wasserzeichen.", .es: "PDF de varias páginas con búsqueda y marca de agua opcional.", .pt: "PDFs de várias páginas pesquisáveis, com marca de água opcional."],
        "plan_yearly": [.en: "Yearly", .fr: "Annuel", .de: "Jährlich", .es: "Anual", .pt: "Anual"],
        "plan_yearly_detail": [.en: "Renews automatically — cancel anytime.", .fr: "Renouvellement automatique — annulable à tout moment.", .de: "Verlängert sich automatisch — jederzeit kündbar.", .es: "Se renueva automáticamente — cancela cuando quieras.", .pt: "Renova automaticamente — cancele quando quiser."],
        "plan_lifetime": [.en: "Lifetime", .fr: "À vie", .de: "Einmalig", .es: "De por vida", .pt: "Vitalício"],
        "plan_lifetime_detail": [.en: "One payment, yours forever.", .fr: "Un seul paiement, à vous pour toujours.", .de: "Einmal zahlen, für immer behalten.", .es: "Un solo pago, tuyo para siempre.", .pt: "Um pagamento, seu para sempre."],
        "pay_start_trial": [.en: "Start free trial", .fr: "Commencer l'essai gratuit", .de: "Kostenlos testen", .es: "Iniciar prueba gratis", .pt: "Iniciar teste grátis"],
        "pay_buy_once": [.en: "Unlock forever", .fr: "Débloquer à vie", .de: "Für immer freischalten", .es: "Desbloquear para siempre", .pt: "Desbloquear para sempre"],
        "pay_continue": [.en: "Continue", .fr: "Continuer", .de: "Weiter", .es: "Continuar", .pt: "Continuar"],
        "pay_free_trial_length": [.en: "%d %@ free, then billed yearly", .fr: "%d %@ offerts, puis facturé chaque année", .de: "%d %@ gratis, danach jährlich", .es: "%d %@ gratis, luego facturación anual", .pt: "%d %@ grátis, depois faturado anualmente"],
        "pay_store_unavailable": [.en: "The App Store isn't reachable right now. Check your connection and try again.", .fr: "L'App Store est injoignable pour le moment. Vérifiez votre connexion et réessayez.", .de: "Der App Store ist gerade nicht erreichbar. Verbindung prüfen und erneut versuchen.", .es: "La App Store no está disponible ahora. Revisa tu conexión e inténtalo de nuevo.", .pt: "A App Store está indisponível. Verifique a ligação e tente novamente."],
        "pay_error_unverified": [.en: "That purchase could not be verified.", .fr: "Cet achat n'a pas pu être vérifié.", .de: "Der Kauf konnte nicht verifiziert werden.", .es: "No se pudo verificar la compra.", .pt: "Não foi possível verificar a compra."],
        "pay_pending": [.en: "Your purchase is pending approval.", .fr: "Votre achat est en attente d'approbation.", .de: "Dein Kauf wartet auf Freigabe.", .es: "Tu compra está pendiente de aprobación.", .pt: "A sua compra aguarda aprovação."],
        "pay_nothing_to_restore": [.en: "No previous purchase found on this Apple Account.", .fr: "Aucun achat précédent trouvé sur ce compte Apple.", .de: "Kein früherer Kauf mit diesem Apple-Konto gefunden.", .es: "No se encontró ninguna compra previa en esta cuenta de Apple.", .pt: "Nenhuma compra anterior encontrada nesta conta Apple."],
        "terms_of_use": [.en: "Terms of Use", .fr: "Conditions d'utilisation", .de: "Nutzungsbedingungen", .es: "Términos de uso", .pt: "Termos de utilização"],
        "manage_subscription": [.en: "Manage subscription", .fr: "Gérer l'abonnement", .de: "Abo verwalten", .es: "Gestionar suscripción", .pt: "Gerir subscrição"],
        "period_day": [.en: "day", .fr: "jour", .de: "Tag", .es: "día", .pt: "dia"],
        "period_days": [.en: "days", .fr: "jours", .de: "Tage", .es: "días", .pt: "dias"],
        "period_week": [.en: "week", .fr: "semaine", .de: "Woche", .es: "semana", .pt: "semana"],
        "period_weeks": [.en: "weeks", .fr: "semaines", .de: "Wochen", .es: "semanas", .pt: "semanas"],
        "period_month": [.en: "month", .fr: "mois", .de: "Monat", .es: "mes", .pt: "mês"],
        "period_months": [.en: "months", .fr: "mois", .de: "Monate", .es: "meses", .pt: "meses"],
        "period_year": [.en: "year", .fr: "an", .de: "Jahr", .es: "año", .pt: "ano"],
        "period_years": [.en: "years", .fr: "ans", .de: "Jahre", .es: "años", .pt: "anos"],
